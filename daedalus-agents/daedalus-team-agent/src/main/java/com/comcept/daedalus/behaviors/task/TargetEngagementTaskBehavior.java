...
public class TargetEngagementTaskBehavior extends AbstractTaskBehavior {

    /**
     * Create a TargetEngagementTaskBehavior.
     *
     * @param taskConnector Connector to send/receive task events
     * @param eventDepot Event buses
     * @return TargetEngagementTaskBehavior
     */
        ...
        Behavior<Task> behavior =
                Behaviors.setup(context ->
                        Behaviors.withTimers(timers ->
                                new TargetEngagementTaskBehavior(
                                        context,
                                        timers,
                                        taskConnector,
                                        eventDepot)
    ...
    private TargetEngagementTaskBehavior(

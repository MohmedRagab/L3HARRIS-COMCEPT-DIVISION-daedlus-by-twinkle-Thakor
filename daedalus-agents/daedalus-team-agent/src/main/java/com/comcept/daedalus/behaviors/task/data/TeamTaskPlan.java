...
public class TeamTaskPlan {

    TaskId taskId;
    MessageState messageState;
    TeamTaskDetails teamTaskDetails;
    TeamTaskStateType teamTaskState;
    TaskStatusType teamTaskStatus;
    TeamTaskStatusDetails teamTaskStatusDetails;
    @Singular Map<PlatformId, PilotTaskPlan> pilotTaskPlans;
    @Singular Map<PlatformId, FusionTaskPlan> fusionTaskPlans;

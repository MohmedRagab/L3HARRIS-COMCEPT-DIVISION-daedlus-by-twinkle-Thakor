...
public class TargetGeolocationTaskBehavior extends AbstractTaskBehavior {

    /**
     * Create a TargetGeolocationTaskBehavior.
     *
     * @param taskConnector Connector to send/receive task events
     * @param eventDepot Event buses
     * @return TargetGeolocationTaskBehavior
     */
        ...
        Behavior<Task> behavior =
                Behaviors.setup(context ->
                        Behaviors.withTimers(timers ->
                                new TargetGeolocationTaskBehavior(
                                        context,
                                        timers,
                                        taskConnector,
                                        eventDepot)
    ...
    private TargetGeolocationTaskBehavior(

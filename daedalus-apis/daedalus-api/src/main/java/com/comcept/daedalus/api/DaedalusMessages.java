 ...
 * @author rrana
 */
public interface DaedalusMessages {

    @SuppressWarnings("FallThrough")
    @Builder
    @Value
    @Accessors(fluent = true)
    class TeamPlatformPosition implements Team, Task, Sensor {

        @NonNull PlatformPosition platformPosition;
    ...
    @Value
    @Accessors(fluent = true)
    class TeamPlatformConfiguration implements Team, Task, Sensor {

        @NonNull PlatformConfiguration platformConfiguration;
